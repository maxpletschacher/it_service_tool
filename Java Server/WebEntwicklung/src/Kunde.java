...
public class Kunde {
	...
	private String PLZ;
	private String ort;
	private String passwort; //Passwort benötigt noch eine Verschlüsselung.
	...
	public Kunde getUser(int id){ //Ich weiß nicht wie ich auf die Tabellenstruktur zugreifen kann
